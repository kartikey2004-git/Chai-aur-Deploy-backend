...
const githubData = {
  ...
  following_url:
    "https://api.github.com/users/kartikey2004-git/following{/other_user}",
  gists_url: "https://api.github.com/users/kartikey2004-git/gists{/gist_id}",
  starred_url:
    "https://api.github.com/users/kartikey2004-git/starred{/owner}{/repo}",
  subscriptions_url:
    "https://api.github.com/users/kartikey2004-git/subscriptions",
  ...
  received_events_url:
    "https://api.github.com/users/kartikey2004-git/received_events",
  type: "User",
